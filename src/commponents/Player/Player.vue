<template>
    <div class="flex fixed bottom-0 left-0 w-screen bg-white dark:bg-[#202227] dark:text-[white]">
    <div class="w-[91vw] m-auto flex items-center justify-between">
            ...
            <div class="w-[18.28vw] flex justify-center items-center">
                <div @click="$player.playOrPause()" class="w-[6.6vw] h-[6.6vw] relative mr-[3.86vw]">
                    ...
                    <Icon :icon="`${$player._playing ? 'carbon:pause-filled' : 'ph:play-fill'}`" class="absolute top-[0.7vw] left-[1vw] w-[3.71vw] h-[4.71vw] dark:text-[#e3e6e8]" />
                </div>
                <!-- <van-circle v-model="currentRate" size="5.6vw" :stroke-width="120" color="#475165" layer-color="#C7CBD2"/> -->
