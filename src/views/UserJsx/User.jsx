            ...
            <Wrapper>
                <div class="bg-[#f5f5f5] pb-[16vw]">
                    ...
                    <section class="w-[100%] px-[4.63vw] box-border" ref='mine'>
                        <div class="w-[91.11vw] rounded-[5vw] text-center bg-white relative top-[-4.26vw] py-[5vw]">
                                ...
                                <div class="w-[100%] overflow-y-scroll " ref="singer">
                                    <ul class="pb-[1vw] mt-[4.29vw] mb-[1.5vw] pl-[4.06vw] w-[175vw] flex justify-around">
                                        {this.singerDate.map((item, index) => (
                                            <li class="flex flex-col items-center justify-center w-[25.06vw] h-[37.6vw] rounded-[3vw] bg-[#f5f5f5]">
                    ...
                    <section class="w-[100%] px-[4.63vw] box-border sticky top-[10vw]">
                        ...
                        <li class="">播客</li> class=""
                    </ul> */}
                        <van-tabs v-model={this.active}>
                            <van-tab title="主页">
                                {/* 音乐品味 */}
