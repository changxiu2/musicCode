<template>
    <div class="">
        <div class="w-screen h-[80.07vw] bg-gradient-to-b from-[#8e5f4a] to-[#a97660] pt-[15vw]">
            <!-- 头部 -->
            <header class="w-screen flex h-[11.19vw] bg-[#8e5f4a] pt-[3.63vw] pl-[5.04vw] pr-[4.09vw] fixed top-0 left-0 z-[3] items-center justify-between mb-[6.21vw]">
                ...
                <div class="h-[29.35vw] flex justify-between">
                    <div class="w-[27.77vw] h-[29vw] rounded-xl relative overflow-hidden shadow-md -top-2">
                        <div class="relative">
                            ...
                            <img class="w-[27.77vw] h-[27.88vw] z-[2] rounded-xl absolute top-[1vw] left-0" :src="detailsDate.coverImgUrl" alt="">
                        </div>
        ...
        <!-- 歌曲列表 -->
        <div class="w-screen">
            <div class=" sticky top-[14.4vw]">
                 <header class="w-screen h-[10.66vw] relative top-[-3.02vw] bg-white pl-[3.11vw] dark:text-white pr-[4.88vw] flex items-center justify-between rounded-t-[3vw]">
                    <div class="flex">
                ...
                <li v-for="(item,index) in singDate" :key="item.id" class="h-[17.94vw] flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-col w-[63.04vw]">
                            ...
                            <div>
                                <div class="text-[2.93vw] text-[#908f97] flex">
